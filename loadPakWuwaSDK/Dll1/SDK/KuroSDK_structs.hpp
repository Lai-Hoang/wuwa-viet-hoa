...
static_assert(sizeof(FAchievementStruct) == 0x000018, "Wrong size on FAchievementStruct");
...
static_assert(offsetof(FAchievementStruct, Progress) == 0x000010, "Member 'FAchievementStruct::Progress' has a wrong offset!");
