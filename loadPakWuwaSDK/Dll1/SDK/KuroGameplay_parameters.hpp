...
static_assert(sizeof(KuroGridLevelActor_SetState) == 0x000010, "Wrong size on KuroGridLevelActor_SetState");
...
static_assert(offsetof(KuroGridLevelActor_SetState, ReturnValue) == 0x00000C, "Member 'KuroGridLevelActor_SetState::ReturnValue' has a wrong offset!");
