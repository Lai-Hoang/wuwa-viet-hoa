...
{
public:
	struct FMovieSceneFloatChannel                TopCurve;                                          // 0x0040(0x00A0)(NativeAccessSpecifierPrivate)
	struct FMovieSceneFloatChannel                LeftCurve;                                         // 0x00E0(0x00A0)(NativeAccessSpecifierPrivate)
	struct FMovieSceneFloatChannel                RightCurve;                                        // 0x0180(0x00A0)(NativeAccessSpecifierPrivate)
	struct FMovieSceneFloatChannel                BottomCurve;                                       // 0x0220(0x00A0)(NativeAccessSpecifierPrivate)
	EMovieSceneBlendType                          BlendType;                                         // 0x02C0(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(FMovieSceneMarginSectionTemplate) == 0x0002C8, "Wrong size on FMovieSceneMarginSectionTemplate");
static_assert(offsetof(FMovieSceneMarginSectionTemplate, TopCurve) == 0x000040, "Member 'FMovieSceneMarginSectionTemplate::TopCurve' has a wrong offset!");
static_assert(offsetof(FMovieSceneMarginSectionTemplate, LeftCurve) == 0x0000E0, "Member 'FMovieSceneMarginSectionTemplate::LeftCurve' has a wrong offset!");
static_assert(offsetof(FMovieSceneMarginSectionTemplate, RightCurve) == 0x000180, "Member 'FMovieSceneMarginSectionTemplate::RightCurve' has a wrong offset!");
static_assert(offsetof(FMovieSceneMarginSectionTemplate, BottomCurve) == 0x000220, "Member 'FMovieSceneMarginSectionTemplate::BottomCurve' has a wrong offset!");
static_assert(offsetof(FMovieSceneMarginSectionTemplate, BlendType) == 0x0002C0, "Member 'FMovieSceneMarginSectionTemplate::BlendType' has a wrong offset!");
...
static_assert(sizeof(FRadialBoxSettings) == 0x00000C, "Wrong size on FRadialBoxSettings");
static_assert(offsetof(FRadialBoxSettings, bDistributeItemsEvenly) == 0x000000, "Member 'FRadialBoxSettings::bDistributeItemsEvenly' has a wrong offset!");
static_assert(offsetof(FRadialBoxSettings, AngleBetweenItems) == 0x000004, "Member 'FRadialBoxSettings::AngleBetweenItems' has a wrong offset!");
static_assert(offsetof(FRadialBoxSettings, StartingAngle) == 0x000008, "Member 'FRadialBoxSettings::StartingAngle' has a wrong offset!");
...
static_assert(sizeof(FRichTextStyleRow) == 0x000290, "Wrong size on FRichTextStyleRow");
...
static_assert(sizeof(FRichImageRow) == 0x000098, "Wrong size on FRichImageRow");
...
static_assert(sizeof(FNamedSlotBinding) == 0x000018, "Wrong size on FNamedSlotBinding");
static_assert(offsetof(FNamedSlotBinding, Name) == 0x000000, "Member 'FNamedSlotBinding::Name' has a wrong offset!");
static_assert(offsetof(FNamedSlotBinding, Content) == 0x000010, "Member 'FNamedSlotBinding::Content' has a wrong offset!");
...
public:
	...
	TDelegate<void()>                             Delegate;                                          // 0x0008(0x0028)(ZeroConstructor, InstancedReference, NativeAccessSpecifierPublic)
	EWidgetAnimationEvent                         AnimationEvent;                                    // 0x0030(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_31[0x3];                                       // 0x0031(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	class FName                                   UserTag;                                           // 0x0034(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FAnimationEventBinding) == 0x000008, "Wrong alignment on FAnimationEventBinding");
static_assert(sizeof(FAnimationEventBinding) == 0x000040, "Wrong size on FAnimationEventBinding");
...
static_assert(offsetof(FAnimationEventBinding, AnimationEvent) == 0x000030, "Member 'FAnimationEventBinding::AnimationEvent' has a wrong offset!");
static_assert(offsetof(FAnimationEventBinding, UserTag) == 0x000034, "Member 'FAnimationEventBinding::UserTag' has a wrong offset!");
...
static_assert(sizeof(FWidgetAnimationBinding) == 0x00002C, "Wrong size on FWidgetAnimationBinding");
...
static_assert(offsetof(FWidgetAnimationBinding, SlotWidgetName) == 0x00000C, "Member 'FWidgetAnimationBinding::SlotWidgetName' has a wrong offset!");
static_assert(offsetof(FWidgetAnimationBinding, AnimationGuid) == 0x000018, "Member 'FWidgetAnimationBinding::AnimationGuid' has a wrong offset!");
static_assert(offsetof(FWidgetAnimationBinding, bIsRootWidget) == 0x000028, "Member 'FWidgetAnimationBinding::bIsRootWidget' has a wrong offset!");
...
static_assert(sizeof(FBlueprintWidgetAnimationDelegateBinding) == 0x000028, "Wrong size on FBlueprintWidgetAnimationDelegateBinding");
...
static_assert(offsetof(FBlueprintWidgetAnimationDelegateBinding, FunctionNameToBind) == 0x000010, "Member 'FBlueprintWidgetAnimationDelegateBinding::FunctionNameToBind' has a wrong offset!");
static_assert(offsetof(FBlueprintWidgetAnimationDelegateBinding, UserTag) == 0x00001C, "Member 'FBlueprintWidgetAnimationDelegateBinding::UserTag' has a wrong offset!");
...
static_assert(offsetof(FDelegateRuntimeBinding, FunctionName) == 0x00001C, "Member 'FDelegateRuntimeBinding::FunctionName' has a wrong offset!");
static_assert(offsetof(FDelegateRuntimeBinding, SourcePath) == 0x000028, "Member 'FDelegateRuntimeBinding::SourcePath' has a wrong offset!");
...
public:
	...
	TDelegate<void(EUINavigation Navigation)>     CustomDelegate;                                    // 0x0018(0x0028)(ZeroConstructor, InstancedReference, NativeAccessSpecifierPublic)
};
static_assert(alignof(FWidgetNavigationData) == 0x000008, "Wrong alignment on FWidgetNavigationData");
static_assert(sizeof(FWidgetNavigationData) == 0x000040, "Wrong size on FWidgetNavigationData");
...
static_assert(offsetof(FWidgetNavigationData, CustomDelegate) == 0x000018, "Member 'FWidgetNavigationData::CustomDelegate' has a wrong offset!");
