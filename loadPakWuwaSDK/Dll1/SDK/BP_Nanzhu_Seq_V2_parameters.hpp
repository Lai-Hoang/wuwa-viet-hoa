...
static_assert(sizeof(BP_Nanzhu_Seq_V2_C_UserConstructionScript) == 0x000468, "Wrong size on BP_Nanzhu_Seq_V2_C_UserConstructionScript");
...
static_assert(offsetof(BP_Nanzhu_Seq_V2_C_UserConstructionScript, CallFunc_GetDataTableRowFromName_ReturnValue) == 0x000448, "Member 'BP_Nanzhu_Seq_V2_C_UserConstructionScript::CallFunc_GetDataTableRowFromName_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_Nanzhu_Seq_V2_C_UserConstructionScript, CallFunc_IsEditor_ReturnValue) == 0x000449, "Member 'BP_Nanzhu_Seq_V2_C_UserConstructionScript::CallFunc_IsEditor_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_Nanzhu_Seq_V2_C_UserConstructionScript, CallFunc_LoadAsset_Blocking_ReturnValue) == 0x000450, "Member 'BP_Nanzhu_Seq_V2_C_UserConstructionScript::CallFunc_LoadAsset_Blocking_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_Nanzhu_Seq_V2_C_UserConstructionScript, K2Node_DynamicCast_As_____) == 0x000458, "Member 'BP_Nanzhu_Seq_V2_C_UserConstructionScript::K2Node_DynamicCast_As_____' has a wrong offset!");
static_assert(offsetof(BP_Nanzhu_Seq_V2_C_UserConstructionScript, K2Node_DynamicCast_bSuccess) == 0x000460, "Member 'BP_Nanzhu_Seq_V2_C_UserConstructionScript::K2Node_DynamicCast_bSuccess' has a wrong offset!");
