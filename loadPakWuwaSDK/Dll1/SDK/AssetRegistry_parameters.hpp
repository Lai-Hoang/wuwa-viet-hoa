...
public:
	...
	class UObject*                                ReturnValue;                                       // 0x0068(0x0008)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	struct FAssetData                             InAssetData;                                       // 0x0000(0x0068)(ConstParm, Parm, OutParm, ReferenceParm, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UClass*                                 ReturnValue;                                       // 0x0068(0x0008)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	struct FAssetData                             InAssetData;                                       // 0x0000(0x0068)(ConstParm, Parm, OutParm, ReferenceParm, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FName                                   InTagName;                                         // 0x0068(0x000C)(ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_74[0x4];                                       // 0x0074(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 OutTagValue;                                       // 0x0078(0x0010)(Parm, OutParm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(AssetRegistryHelpers_GetTagValue) == 0x000090, "Wrong size on AssetRegistryHelpers_GetTagValue");
...
static_assert(offsetof(AssetRegistryHelpers_GetTagValue, OutTagValue) == 0x000078, "Member 'AssetRegistryHelpers_GetTagValue::OutTagValue' has a wrong offset!");
static_assert(offsetof(AssetRegistryHelpers_GetTagValue, ReturnValue) == 0x000088, "Member 'AssetRegistryHelpers_GetTagValue::ReturnValue' has a wrong offset!");
...
// Function AssetRegistry.AssetRegistry.IsPathForceScanned
// 0x0018 (0x0018 - 0x0000)
struct AssetRegistry_IsPathForceScanned final
{
public:
...
static_assert(alignof(AssetRegistry_IsPathForceScanned) == 0x000008, "Wrong alignment on AssetRegistry_IsPathForceScanned");
static_assert(sizeof(AssetRegistry_IsPathForceScanned) == 0x000018, "Wrong size on AssetRegistry_IsPathForceScanned");
static_assert(offsetof(AssetRegistry_IsPathForceScanned, InPath) == 0x000000, "Member 'AssetRegistry_IsPathForceScanned::InPath' has a wrong offset!");
static_assert(offsetof(AssetRegistry_IsPathForceScanned, ReturnValue) == 0x000010, "Member 'AssetRegistry_IsPathForceScanned::ReturnValue' has a wrong offset!");

// Function AssetRegistry.AssetRegistry.IsPathsForceScanned
// 0x0018 (0x0018 - 0x0000)
struct AssetRegistry_IsPathsForceScanned final
{
public:
...
static_assert(alignof(AssetRegistry_IsPathsForceScanned) == 0x000008, "Wrong alignment on AssetRegistry_IsPathsForceScanned");
static_assert(sizeof(AssetRegistry_IsPathsForceScanned) == 0x000018, "Wrong size on AssetRegistry_IsPathsForceScanned");
static_assert(offsetof(AssetRegistry_IsPathsForceScanned, InPaths) == 0x000000, "Member 'AssetRegistry_IsPathsForceScanned::InPaths' has a wrong offset!");
static_assert(offsetof(AssetRegistry_IsPathsForceScanned, ReturnValue) == 0x000010, "Member 'AssetRegistry_IsPathsForceScanned::ReturnValue' has a wrong offset!");
...
static_assert(offsetof(AssetRegistry_GetAssetByObjectPath, bIncludeOnlyOnDiskAssets) == 0x00000C, "Member 'AssetRegistry_GetAssetByObjectPath::bIncludeOnlyOnDiskAssets' has a wrong offset!");
...
static_assert(sizeof(AssetRegistry_GetAssetsByPackageName) == 0x000028, "Wrong size on AssetRegistry_GetAssetsByPackageName");
...
static_assert(offsetof(AssetRegistry_GetAssetsByPackageName, OutAssetData) == 0x000010, "Member 'AssetRegistry_GetAssetsByPackageName::OutAssetData' has a wrong offset!");
static_assert(offsetof(AssetRegistry_GetAssetsByPackageName, bIncludeOnlyOnDiskAssets) == 0x000020, "Member 'AssetRegistry_GetAssetsByPackageName::bIncludeOnlyOnDiskAssets' has a wrong offset!");
static_assert(offsetof(AssetRegistry_GetAssetsByPackageName, ReturnValue) == 0x000021, "Member 'AssetRegistry_GetAssetsByPackageName::ReturnValue' has a wrong offset!");
...
static_assert(offsetof(AssetRegistry_GetAssetsByPath, OutAssetData) == 0x000010, "Member 'AssetRegistry_GetAssetsByPath::OutAssetData' has a wrong offset!");
static_assert(offsetof(AssetRegistry_GetAssetsByPath, bRecursive) == 0x000020, "Member 'AssetRegistry_GetAssetsByPath::bRecursive' has a wrong offset!");
static_assert(offsetof(AssetRegistry_GetAssetsByPath, bIncludeOnlyOnDiskAssets) == 0x000021, "Member 'AssetRegistry_GetAssetsByPath::bIncludeOnlyOnDiskAssets' has a wrong offset!");
static_assert(offsetof(AssetRegistry_GetAssetsByPath, ReturnValue) == 0x000022, "Member 'AssetRegistry_GetAssetsByPath::ReturnValue' has a wrong offset!");
...
static_assert(offsetof(AssetRegistry_HasAssets, bRecursive) == 0x00000C, "Member 'AssetRegistry_HasAssets::bRecursive' has a wrong offset!");
static_assert(offsetof(AssetRegistry_HasAssets, ReturnValue) == 0x00000D, "Member 'AssetRegistry_HasAssets::ReturnValue' has a wrong offset!");

// Function AssetRegistry.AssetRegistry.IsAssetPathLoaded
// 0x0018 (0x0018 - 0x0000)
struct AssetRegistry_IsAssetPathLoaded final
{
public:
	class FString                                 Path;                                              // 0x0000(0x0010)(Parm, OutParm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          ReturnValue;                                       // 0x0010(0x0001)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_11[0x7];                                       // 0x0011(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(AssetRegistry_IsAssetPathLoaded) == 0x000008, "Wrong alignment on AssetRegistry_IsAssetPathLoaded");
static_assert(sizeof(AssetRegistry_IsAssetPathLoaded) == 0x000018, "Wrong size on AssetRegistry_IsAssetPathLoaded");
static_assert(offsetof(AssetRegistry_IsAssetPathLoaded, Path) == 0x000000, "Member 'AssetRegistry_IsAssetPathLoaded::Path' has a wrong offset!");
static_assert(offsetof(AssetRegistry_IsAssetPathLoaded, ReturnValue) == 0x000010, "Member 'AssetRegistry_IsAssetPathLoaded::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(AssetRegistry_K2_GetDependencies) == 0x000030, "Wrong size on AssetRegistry_K2_GetDependencies");
...
static_assert(offsetof(AssetRegistry_K2_GetDependencies, DependencyOptions) == 0x00000C, "Member 'AssetRegistry_K2_GetDependencies::DependencyOptions' has a wrong offset!");
static_assert(offsetof(AssetRegistry_K2_GetDependencies, OutDependencies) == 0x000018, "Member 'AssetRegistry_K2_GetDependencies::OutDependencies' has a wrong offset!");
static_assert(offsetof(AssetRegistry_K2_GetDependencies, ReturnValue) == 0x000028, "Member 'AssetRegistry_K2_GetDependencies::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(AssetRegistry_K2_GetReferencers) == 0x000030, "Wrong size on AssetRegistry_K2_GetReferencers");
...
static_assert(offsetof(AssetRegistry_K2_GetReferencers, ReferenceOptions) == 0x00000C, "Member 'AssetRegistry_K2_GetReferencers::ReferenceOptions' has a wrong offset!");
static_assert(offsetof(AssetRegistry_K2_GetReferencers, OutReferencers) == 0x000018, "Member 'AssetRegistry_K2_GetReferencers::OutReferencers' has a wrong offset!");
static_assert(offsetof(AssetRegistry_K2_GetReferencers, ReturnValue) == 0x000028, "Member 'AssetRegistry_K2_GetReferencers::ReturnValue' has a wrong offset!");
