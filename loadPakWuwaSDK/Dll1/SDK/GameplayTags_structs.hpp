...
static_assert(sizeof(FGameplayTagTableRow) == 0x000028, "Wrong size on FGameplayTagTableRow");
...
static_assert(sizeof(FGameplayTagNode) == 0x000070, "Wrong size on FGameplayTagNode");
...
static_assert(sizeof(FGameplayTagRedirect) == 0x000018, "Wrong size on FGameplayTagRedirect");
...
static_assert(offsetof(FGameplayTagRedirect, NewTagName) == 0x00000C, "Member 'FGameplayTagRedirect::NewTagName' has a wrong offset!");
