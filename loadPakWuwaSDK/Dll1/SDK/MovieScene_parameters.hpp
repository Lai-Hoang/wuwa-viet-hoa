...
static_assert(alignof(MovieSceneSection_GetEndFrame) == 0x000004, "Wrong alignment on MovieSceneSection_GetEndFrame");
static_assert(sizeof(MovieSceneSection_GetEndFrame) == 0x000008, "Wrong size on MovieSceneSection_GetEndFrame");
static_assert(offsetof(MovieSceneSection_GetEndFrame, ReturnValue) == 0x000000, "Member 'MovieSceneSection_GetEndFrame::ReturnValue' has a wrong offset!");
...
static_assert(alignof(MovieSceneSection_GetStartFrame) == 0x000004, "Wrong alignment on MovieSceneSection_GetStartFrame");
static_assert(sizeof(MovieSceneSection_GetStartFrame) == 0x000008, "Wrong size on MovieSceneSection_GetStartFrame");
static_assert(offsetof(MovieSceneSection_GetStartFrame, ReturnValue) == 0x000000, "Member 'MovieSceneSection_GetStartFrame::ReturnValue' has a wrong offset!");
...
static_assert(alignof(MovieSceneSequence_FindBindingsByBothTags) == 0x000008, "Wrong alignment on MovieSceneSequence_FindBindingsByBothTags");
static_assert(sizeof(MovieSceneSequence_FindBindingsByBothTags) == 0x000020, "Wrong size on MovieSceneSequence_FindBindingsByBothTags");
static_assert(offsetof(MovieSceneSequence_FindBindingsByBothTags, InBindingNames) == 0x000000, "Member 'MovieSceneSequence_FindBindingsByBothTags::InBindingNames' has a wrong offset!");
static_assert(offsetof(MovieSceneSequence_FindBindingsByBothTags, ReturnValue) == 0x000010, "Member 'MovieSceneSequence_FindBindingsByBothTags::ReturnValue' has a wrong offset!");
...
// 0x0001 (0x0001 - 0x0000)
struct MovieSceneSequencePlayer_GoToEndAndStop final
{
public:
	EUpdatePositionMethod                         UpdateMethod;                                      // 0x0000(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(MovieSceneSequencePlayer_GoToEndAndStop) == 0x000001, "Wrong alignment on MovieSceneSequencePlayer_GoToEndAndStop");
static_assert(sizeof(MovieSceneSequencePlayer_GoToEndAndStop) == 0x000001, "Wrong size on MovieSceneSequencePlayer_GoToEndAndStop");
static_assert(offsetof(MovieSceneSequencePlayer_GoToEndAndStop, UpdateMethod) == 0x000000, "Member 'MovieSceneSequencePlayer_GoToEndAndStop::UpdateMethod' has a wrong offset!");
...
// 0x0004 (0x0004 - 0x0000)
struct MovieSceneSequencePlayer_PlayReverseLooping final
{
public:
	int32                                         NumLoops;                                          // 0x0000(0x0004)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(MovieSceneSequencePlayer_PlayReverseLooping) == 0x000004, "Wrong alignment on MovieSceneSequencePlayer_PlayReverseLooping");
static_assert(sizeof(MovieSceneSequencePlayer_PlayReverseLooping) == 0x000004, "Wrong size on MovieSceneSequencePlayer_PlayReverseLooping");
static_assert(offsetof(MovieSceneSequencePlayer_PlayReverseLooping, NumLoops) == 0x000000, "Member 'MovieSceneSequencePlayer_PlayReverseLooping::NumLoops' has a wrong offset!");
...
struct MovieSceneSequencePlayer_PlayTo_Circle final
{
public:
...
// 0x0010 (0x0010 - 0x0000)
struct MovieSceneSequencePlayer_SetKeyFrames final
{
public:
	TArray<int32>                                 InKeyFrames;                                       // 0x0000(0x0010)(ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, NativeAccessSpecifierPublic)
};
static_assert(alignof(MovieSceneSequencePlayer_SetKeyFrames) == 0x000008, "Wrong alignment on MovieSceneSequencePlayer_SetKeyFrames");
static_assert(sizeof(MovieSceneSequencePlayer_SetKeyFrames) == 0x000010, "Wrong size on MovieSceneSequencePlayer_SetKeyFrames");
static_assert(offsetof(MovieSceneSequencePlayer_SetKeyFrames, InKeyFrames) == 0x000000, "Member 'MovieSceneSequencePlayer_SetKeyFrames::InKeyFrames' has a wrong offset!");
...
// 0x0028 (0x0028 - 0x0000)
struct MovieSceneSequencePlayer_SetPlaybackPositionWithNoEval final
{
public:
	struct FMovieSceneSequencePlaybackParams      PlaybackParams;                                    // 0x0000(0x0028)(Parm, NativeAccessSpecifierPublic)
};
static_assert(alignof(MovieSceneSequencePlayer_SetPlaybackPositionWithNoEval) == 0x000008, "Wrong alignment on MovieSceneSequencePlayer_SetPlaybackPositionWithNoEval");
static_assert(sizeof(MovieSceneSequencePlayer_SetPlaybackPositionWithNoEval) == 0x000028, "Wrong size on MovieSceneSequencePlayer_SetPlaybackPositionWithNoEval");
static_assert(offsetof(MovieSceneSequencePlayer_SetPlaybackPositionWithNoEval, PlaybackParams) == 0x000000, "Member 'MovieSceneSequencePlayer_SetPlaybackPositionWithNoEval::PlaybackParams' has a wrong offset!");
...
// 0x0001 (0x0001 - 0x0000)
struct MovieSceneSequencePlayer_IsStopped final
{
public:
	bool                                          ReturnValue;                                       // 0x0000(0x0001)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(MovieSceneSequencePlayer_IsStopped) == 0x000001, "Wrong alignment on MovieSceneSequencePlayer_IsStopped");
