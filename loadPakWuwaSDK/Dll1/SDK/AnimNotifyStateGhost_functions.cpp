...
#include "AnimNotifyStateGhost_classes.hpp"
#include "AnimNotifyStateGhost_parameters.hpp"
...
bool UAnimNotifyStateGhost_C::K2_NotifyEnd(class USkeletalMeshComponent* MeshComp, class UAnimSequenceBase* Animation)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("AnimNotifyStateGhost_C", "K2_NotifyEnd");

	Params::AnimNotifyStateGhost_C_K2_NotifyEnd Parms{};
...
class FString UAnimNotifyStateGhost_C::GetNotifyName() const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("AnimNotifyStateGhost_C", "GetNotifyName");
