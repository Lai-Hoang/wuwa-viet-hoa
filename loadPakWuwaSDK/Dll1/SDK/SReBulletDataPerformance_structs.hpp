...
{
public:
	bool                                          接手父子弹的特效_80_9F7DC8A841D73FDC00EB84A17B1275EB; // 0x0000(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	TSoftClassPtr<class UClass>                   命中时受击者震屏_77_9E34F7C7455CF6C4C40B0DA0A3203F85; // 0x01A0(0x0030)(Edit, BlueprintVisible, HasGetValueTypeHash)
	TSoftClassPtr<class UClass>                   命中弱点时攻击者震屏_133_F3A8C1A34D99B6D841C2E4A229358EA3; // 0x01D0(0x0030)(Edit, BlueprintVisible, HasGetValueTypeHash)
	int32                                         最大震动次数_27_10EF5EBC4E5B7C5410227AB80FD9EEEF;  // 0x0200(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
