...
static_assert(alignof(FNavBatchProjectionResult) == 0x000008, "Wrong alignment on FNavBatchProjectionResult");
static_assert(sizeof(FNavBatchProjectionResult) == 0x000020, "Wrong size on FNavBatchProjectionResult");
static_assert(offsetof(FNavBatchProjectionResult, OutLocation) == 0x000000, "Member 'FNavBatchProjectionResult::OutLocation' has a wrong offset!");
static_assert(offsetof(FNavBatchProjectionResult, bResult) == 0x000018, "Member 'FNavBatchProjectionResult::bResult' has a wrong offset!");
...
public:
	...
	float                                         DetailSampleDist;                                  // 0x002C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         TileNumberHardLimit;                               // 0x0030(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ERecastPartitioning                           RegionPartitioning;                                // 0x0034(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ERecastPartitioning                           LayerPartitioning;                                 // 0x0035(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
