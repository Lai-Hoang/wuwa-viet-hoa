...
static_assert(offsetof(FMovieSceneMediaPlayerPropertySectionTemplate, MediaSource) == 0x000040, "Member 'FMovieSceneMediaPlayerPropertySectionTemplate::MediaSource' has a wrong offset!");
static_assert(offsetof(FMovieSceneMediaPlayerPropertySectionTemplate, SectionStartFrame) == 0x000048, "Member 'FMovieSceneMediaPlayerPropertySectionTemplate::SectionStartFrame' has a wrong offset!");
static_assert(offsetof(FMovieSceneMediaPlayerPropertySectionTemplate, bLoop) == 0x00004C, "Member 'FMovieSceneMediaPlayerPropertySectionTemplate::bLoop' has a wrong offset!");
