...
static_assert(sizeof(USourceEffectChorusPreset) == 0x000188, "Wrong size on USourceEffectChorusPreset");
static_assert(offsetof(USourceEffectChorusPreset, Settings) == 0x000110, "Member 'USourceEffectChorusPreset::Settings' has a wrong offset!");
...
static_assert(offsetof(UModularSynthPresetBank, Presets) == 0x000030, "Member 'UModularSynthPresetBank::Presets' has a wrong offset!");
...
static_assert(sizeof(USourceEffectDynamicsProcessorPreset) == 0x0000E8, "Wrong size on USourceEffectDynamicsProcessorPreset");
static_assert(offsetof(USourceEffectDynamicsProcessorPreset, Settings) == 0x0000C0, "Member 'USourceEffectDynamicsProcessorPreset::Settings' has a wrong offset!");
...
static_assert(sizeof(UModularSynthLibrary) == 0x000030, "Wrong size on UModularSynthLibrary");

// Class Synthesis.ModularSynthComponent
// 0x06C0 (0x0DA0 - 0x06E0)
class UModularSynthComponent final : public USynthComponent
{
public:
	int32                                         VoiceCount;                                        // 0x06E0(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_6E4[0x6BC];                                    // 0x06E4(0x06BC)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UModularSynthComponent) == 0x000DA0, "Wrong size on UModularSynthComponent");
static_assert(offsetof(UModularSynthComponent, VoiceCount) == 0x0006E0, "Member 'UModularSynthComponent::VoiceCount' has a wrong offset!");
...
static_assert(sizeof(USourceEffectBitCrusherPreset) == 0x0000F8, "Wrong size on USourceEffectBitCrusherPreset");
static_assert(offsetof(USourceEffectBitCrusherPreset, Settings) == 0x0000C8, "Member 'USourceEffectBitCrusherPreset::Settings' has a wrong offset!");
...
static_assert(sizeof(USourceEffectEnvelopeFollowerPreset) == 0x0000B0, "Wrong size on USourceEffectEnvelopeFollowerPreset");
static_assert(offsetof(USourceEffectEnvelopeFollowerPreset, Settings) == 0x0000A4, "Member 'USourceEffectEnvelopeFollowerPreset::Settings' has a wrong offset!");
...
static_assert(sizeof(USourceEffectEQPreset) == 0x0000B8, "Wrong size on USourceEffectEQPreset");
static_assert(offsetof(USourceEffectEQPreset, Settings) == 0x0000A8, "Member 'USourceEffectEQPreset::Settings' has a wrong offset!");
...
static_assert(sizeof(USourceEffectFilterPreset) == 0x0000D8, "Wrong size on USourceEffectFilterPreset");
static_assert(offsetof(USourceEffectFilterPreset, Settings) == 0x0000B8, "Member 'USourceEffectFilterPreset::Settings' has a wrong offset!");
...
static_assert(sizeof(USourceEffectFoldbackDistortionPreset) == 0x0000B0, "Wrong size on USourceEffectFoldbackDistortionPreset");
static_assert(offsetof(USourceEffectFoldbackDistortionPreset, Settings) == 0x0000A4, "Member 'USourceEffectFoldbackDistortionPreset::Settings' has a wrong offset!");
...
static_assert(sizeof(USourceEffectMidSideSpreaderPreset) == 0x0000A8, "Wrong size on USourceEffectMidSideSpreaderPreset");
static_assert(offsetof(USourceEffectMidSideSpreaderPreset, Settings) == 0x0000A0, "Member 'USourceEffectMidSideSpreaderPreset::Settings' has a wrong offset!");
...
static_assert(sizeof(USourceEffectPannerPreset) == 0x0000A8, "Wrong size on USourceEffectPannerPreset");
static_assert(offsetof(USourceEffectPannerPreset, Settings) == 0x0000A0, "Member 'USourceEffectPannerPreset::Settings' has a wrong offset!");
...
static_assert(sizeof(USourceEffectPhaserPreset) == 0x0000B8, "Wrong size on USourceEffectPhaserPreset");
static_assert(offsetof(USourceEffectPhaserPreset, Settings) == 0x0000A8, "Member 'USourceEffectPhaserPreset::Settings' has a wrong offset!");
...
static_assert(offsetof(USourceEffectRingModulationPreset, Settings) == 0x0000B8, "Member 'USourceEffectRingModulationPreset::Settings' has a wrong offset!");
...
static_assert(offsetof(USourceEffectSimpleDelayPreset, Settings) == 0x0000B0, "Member 'USourceEffectSimpleDelayPreset::Settings' has a wrong offset!");
...
static_assert(sizeof(USourceEffectStereoDelayPreset) == 0x0000E0, "Wrong size on USourceEffectStereoDelayPreset");
static_assert(offsetof(USourceEffectStereoDelayPreset, Settings) == 0x0000BC, "Member 'USourceEffectStereoDelayPreset::Settings' has a wrong offset!");
...
static_assert(sizeof(USourceEffectWaveShaperPreset) == 0x0000A8, "Wrong size on USourceEffectWaveShaperPreset");
static_assert(offsetof(USourceEffectWaveShaperPreset, Settings) == 0x0000A0, "Member 'USourceEffectWaveShaperPreset::Settings' has a wrong offset!");
...
static_assert(sizeof(UAudioImpulseResponse) == 0x000060, "Wrong size on UAudioImpulseResponse");
static_assert(offsetof(UAudioImpulseResponse, ImpulseResponse) == 0x000030, "Member 'UAudioImpulseResponse::ImpulseResponse' has a wrong offset!");
static_assert(offsetof(UAudioImpulseResponse, NumChannels) == 0x000040, "Member 'UAudioImpulseResponse::NumChannels' has a wrong offset!");
static_assert(offsetof(UAudioImpulseResponse, SampleRate) == 0x000044, "Member 'UAudioImpulseResponse::SampleRate' has a wrong offset!");
static_assert(offsetof(UAudioImpulseResponse, NormalizationVolumeDb) == 0x000048, "Member 'UAudioImpulseResponse::NormalizationVolumeDb' has a wrong offset!");
static_assert(offsetof(UAudioImpulseResponse, bTrueStereo) == 0x00004C, "Member 'UAudioImpulseResponse::bTrueStereo' has a wrong offset!");
static_assert(offsetof(UAudioImpulseResponse, IRData) == 0x000050, "Member 'UAudioImpulseResponse::IRData' has a wrong offset!");
...
static_assert(sizeof(USubmixEffectConvolutionReverbPreset) == 0x0000F8, "Wrong size on USubmixEffectConvolutionReverbPreset");
static_assert(offsetof(USubmixEffectConvolutionReverbPreset, ImpulseResponse) == 0x000070, "Member 'USubmixEffectConvolutionReverbPreset::ImpulseResponse' has a wrong offset!");
static_assert(offsetof(USubmixEffectConvolutionReverbPreset, Settings) == 0x000078, "Member 'USubmixEffectConvolutionReverbPreset::Settings' has a wrong offset!");
...
static_assert(sizeof(USubmixEffectDelayPreset) == 0x0000C0, "Wrong size on USubmixEffectDelayPreset");
static_assert(offsetof(USubmixEffectDelayPreset, Settings) == 0x0000A4, "Member 'USubmixEffectDelayPreset::Settings' has a wrong offset!");
static_assert(offsetof(USubmixEffectDelayPreset, DynamicSettings) == 0x0000B0, "Member 'USubmixEffectDelayPreset::DynamicSettings' has a wrong offset!");
...
static_assert(sizeof(USubmixEffectFilterPreset) == 0x0000B0, "Wrong size on USubmixEffectFilterPreset");
static_assert(offsetof(USubmixEffectFilterPreset, Settings) == 0x0000A4, "Member 'USubmixEffectFilterPreset::Settings' has a wrong offset!");
...
static_assert(sizeof(USubmixEffectFlexiverbPreset) == 0x0000B8, "Wrong size on USubmixEffectFlexiverbPreset");
static_assert(offsetof(USubmixEffectFlexiverbPreset, Settings) == 0x0000A8, "Member 'USubmixEffectFlexiverbPreset::Settings' has a wrong offset!");
...
static_assert(sizeof(USubmixEffectMultibandCompressorPreset) == 0x0000D8, "Wrong size on USubmixEffectMultibandCompressorPreset");
static_assert(offsetof(USubmixEffectMultibandCompressorPreset, Settings) == 0x0000B8, "Member 'USubmixEffectMultibandCompressorPreset::Settings' has a wrong offset!");
...
static_assert(sizeof(USubmixEffectStereoDelayPreset) == 0x0000E0, "Wrong size on USubmixEffectStereoDelayPreset");
static_assert(offsetof(USubmixEffectStereoDelayPreset, Settings) == 0x0000BC, "Member 'USubmixEffectStereoDelayPreset::Settings' has a wrong offset!");
...
public:
	...
	TDelegate<void()>                             ValueXDelegate;                                    // 0x0178(0x0028)(ZeroConstructor, InstancedReference, NativeAccessSpecifierPublic)
	TDelegate<void()>                             ValueYDelegate;                                    // 0x01A0(0x0028)(ZeroConstructor, InstancedReference, NativeAccessSpecifierPublic)
	struct FSynth2DSliderStyle                    WidgetStyle;                                       // 0x01C8(0x02E0)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FLinearColor                           SliderHandleColor;                                 // 0x04A8(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          IndentHandle;                                      // 0x04B8(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          Locked;                                            // 0x04B9(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_4BA[0x2];                                      // 0x04BA(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         StepSize;                                          // 0x04BC(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          IsFocusable;                                       // 0x04C0(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	TMulticastInlineDelegate<void(float Value)>   OnValueChangedX;                                   // 0x0508(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(float Value)>   OnValueChangedY;                                   // 0x0518(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(USynth2DSlider) == 0x000538, "Wrong size on USynth2DSlider");
static_assert(offsetof(USynth2DSlider, ValueX) == 0x000170, "Member 'USynth2DSlider::ValueX' has a wrong offset!");
static_assert(offsetof(USynth2DSlider, ValueY) == 0x000174, "Member 'USynth2DSlider::ValueY' has a wrong offset!");
static_assert(offsetof(USynth2DSlider, ValueXDelegate) == 0x000178, "Member 'USynth2DSlider::ValueXDelegate' has a wrong offset!");
static_assert(offsetof(USynth2DSlider, ValueYDelegate) == 0x0001A0, "Member 'USynth2DSlider::ValueYDelegate' has a wrong offset!");
static_assert(offsetof(USynth2DSlider, WidgetStyle) == 0x0001C8, "Member 'USynth2DSlider::WidgetStyle' has a wrong offset!");
static_assert(offsetof(USynth2DSlider, SliderHandleColor) == 0x0004A8, "Member 'USynth2DSlider::SliderHandleColor' has a wrong offset!");
static_assert(offsetof(USynth2DSlider, IndentHandle) == 0x0004B8, "Member 'USynth2DSlider::IndentHandle' has a wrong offset!");
static_assert(offsetof(USynth2DSlider, Locked) == 0x0004B9, "Member 'USynth2DSlider::Locked' has a wrong offset!");
static_assert(offsetof(USynth2DSlider, StepSize) == 0x0004BC, "Member 'USynth2DSlider::StepSize' has a wrong offset!");
static_assert(offsetof(USynth2DSlider, IsFocusable) == 0x0004C0, "Member 'USynth2DSlider::IsFocusable' has a wrong offset!");
static_assert(offsetof(USynth2DSlider, OnMouseCaptureBegin) == 0x0004C8, "Member 'USynth2DSlider::OnMouseCaptureBegin' has a wrong offset!");
static_assert(offsetof(USynth2DSlider, OnMouseCaptureEnd) == 0x0004D8, "Member 'USynth2DSlider::OnMouseCaptureEnd' has a wrong offset!");
static_assert(offsetof(USynth2DSlider, OnControllerCaptureBegin) == 0x0004E8, "Member 'USynth2DSlider::OnControllerCaptureBegin' has a wrong offset!");
static_assert(offsetof(USynth2DSlider, OnControllerCaptureEnd) == 0x0004F8, "Member 'USynth2DSlider::OnControllerCaptureEnd' has a wrong offset!");
static_assert(offsetof(USynth2DSlider, OnValueChangedX) == 0x000508, "Member 'USynth2DSlider::OnValueChangedX' has a wrong offset!");
static_assert(offsetof(USynth2DSlider, OnValueChangedY) == 0x000518, "Member 'USynth2DSlider::OnValueChangedY' has a wrong offset!");

// Class Synthesis.GranularSynth
// 0x03C0 (0x0AA0 - 0x06E0)
...
public:
	...
	uint8                                         Pad_6E8[0x3B8];                                    // 0x06E8(0x03B8)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UGranularSynth) == 0x000AA0, "Wrong size on UGranularSynth");
static_assert(offsetof(UGranularSynth, GranulatedSoundWave) == 0x0006E0, "Member 'UGranularSynth::GranulatedSoundWave' has a wrong offset!");
...
static_assert(sizeof(UMonoWaveTableSynthPreset) == 0x000178, "Wrong size on UMonoWaveTableSynthPreset");
static_assert(offsetof(UMonoWaveTableSynthPreset, PresetName) == 0x000030, "Member 'UMonoWaveTableSynthPreset::PresetName' has a wrong offset!");
static_assert(offsetof(UMonoWaveTableSynthPreset, LockKeyframesToGrid) == 0x000044, "Member 'UMonoWaveTableSynthPreset::LockKeyframesToGrid' has a wrong offset!");
static_assert(offsetof(UMonoWaveTableSynthPreset, WaveTableResolution) == 0x000048, "Member 'UMonoWaveTableSynthPreset::WaveTableResolution' has a wrong offset!");
static_assert(offsetof(UMonoWaveTableSynthPreset, WaveTable) == 0x000050, "Member 'UMonoWaveTableSynthPreset::WaveTable' has a wrong offset!");

// Class Synthesis.SynthComponentMonoWaveTable
// 0x0740 (0x0E20 - 0x06E0)
class USynthComponentMonoWaveTable final : public USynthComponent
{
public:
	TMulticastInlineDelegate<void(int32 TableIndex)> OnTableAltered;                                 // 0x06E0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void()>              OnNumTablesChanged;                                // 0x06F0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	...
	uint8                                         Pad_708[0x718];                                    // 0x0708(0x0718)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(USynthComponentMonoWaveTable) == 0x000E20, "Wrong size on USynthComponentMonoWaveTable");
static_assert(offsetof(USynthComponentMonoWaveTable, OnTableAltered) == 0x0006E0, "Member 'USynthComponentMonoWaveTable::OnTableAltered' has a wrong offset!");
static_assert(offsetof(USynthComponentMonoWaveTable, OnNumTablesChanged) == 0x0006F0, "Member 'USynthComponentMonoWaveTable::OnNumTablesChanged' has a wrong offset!");
static_assert(offsetof(USynthComponentMonoWaveTable, CurrentPreset) == 0x000700, "Member 'USynthComponentMonoWaveTable::CurrentPreset' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_6E8[0x18];                                     // 0x06E8(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(USynthComponentToneGenerator, Frequency) == 0x0006E0, "Member 'USynthComponentToneGenerator::Frequency' has a wrong offset!");
static_assert(offsetof(USynthComponentToneGenerator, Volume) == 0x0006E4, "Member 'USynthComponentToneGenerator::Volume' has a wrong offset!");
...
public:
	...
	TMulticastInlineDelegate<void()>              OnSampleLoaded;                                    // 0x06E8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(float ProgressPercent, float ProgressTimeSeconds)> OnSamplePlaybackProgress; // 0x06F8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_708[0x108];                                    // 0x0708(0x0108)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(USynthSamplePlayer) == 0x000810, "Wrong size on USynthSamplePlayer");
static_assert(offsetof(USynthSamplePlayer, SoundWave) == 0x0006E0, "Member 'USynthSamplePlayer::SoundWave' has a wrong offset!");
static_assert(offsetof(USynthSamplePlayer, OnSampleLoaded) == 0x0006E8, "Member 'USynthSamplePlayer::OnSampleLoaded' has a wrong offset!");
static_assert(offsetof(USynthSamplePlayer, OnSamplePlaybackProgress) == 0x0006F8, "Member 'USynthSamplePlayer::OnSamplePlaybackProgress' has a wrong offset!");
...
public:
	...
	TMulticastInlineDelegate<void()>              OnMouseCaptureBegin;                               // 0x0440(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void()>              OnMouseCaptureEnd;                                 // 0x0450(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void()>              OnControllerCaptureBegin;                          // 0x0460(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void()>              OnControllerCaptureEnd;                            // 0x0470(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(float Value)>   OnValueChanged;                                    // 0x0480(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
