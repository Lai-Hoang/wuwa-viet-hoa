...
static_assert(sizeof(FNodeObject) == 0x000018, "Wrong size on FNodeObject");
static_assert(offsetof(FNodeObject, Name) == 0x000000, "Member 'FNodeObject::Name' has a wrong offset!");
static_assert(offsetof(FNodeObject, ParentName) == 0x00000C, "Member 'FNodeObject::ParentName' has a wrong offset!");
...
static_assert(sizeof(FTransformConstraint) == 0x000030, "Wrong size on FTransformConstraint");
...
static_assert(offsetof(FTransformConstraint, TargetNode) == 0x00001C, "Member 'FTransformConstraint::TargetNode' has a wrong offset!");
static_assert(offsetof(FTransformConstraint, Weight) == 0x000028, "Member 'FTransformConstraint::Weight' has a wrong offset!");
static_assert(offsetof(FTransformConstraint, bMaintainOffset) == 0x00002C, "Member 'FTransformConstraint::bMaintainOffset' has a wrong offset!");
