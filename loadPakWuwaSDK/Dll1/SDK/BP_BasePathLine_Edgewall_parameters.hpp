...
static_assert(alignof(BP_BasePathLine_Edgewall_C_贴地处理) == 0x000004, "Wrong alignment on BP_BasePathLine_Edgewall_C_贴地处理");
static_assert(sizeof(BP_BasePathLine_Edgewall_C_贴地处理) == 0x00002C, "Wrong size on BP_BasePathLine_Edgewall_C_贴地处理");
static_assert(offsetof(BP_BasePathLine_Edgewall_C_贴地处理, ___int_Variable) == 0x000000, "Member 'BP_BasePathLine_Edgewall_C_贴地处理::___int_Variable' has a wrong offset!");
static_assert(offsetof(BP_BasePathLine_Edgewall_C_贴地处理, CallFunc_GetLocationAtSplinePoint_ReturnValue) == 0x000004, "Member 'BP_BasePathLine_Edgewall_C_贴地处理::CallFunc_GetLocationAtSplinePoint_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_BasePathLine_Edgewall_C_贴地处理, CallFunc_K2_ProjectPointToNavigation_ProjectedLocation) == 0x000010, "Member 'BP_BasePathLine_Edgewall_C_贴地处理::CallFunc_K2_ProjectPointToNavigation_ProjectedLocation' has a wrong offset!");
static_assert(offsetof(BP_BasePathLine_Edgewall_C_贴地处理, CallFunc_K2_ProjectPointToNavigation_ReturnValue) == 0x00001C, "Member 'BP_BasePathLine_Edgewall_C_贴地处理::CallFunc_K2_ProjectPointToNavigation_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_BasePathLine_Edgewall_C_贴地处理, CallFunc_Add_IntInt_ReturnValue) == 0x000020, "Member 'BP_BasePathLine_Edgewall_C_贴地处理::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
