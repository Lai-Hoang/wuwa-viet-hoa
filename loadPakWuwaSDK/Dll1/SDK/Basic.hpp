...
namespace Offsets
{
	constexpr int32 GObjects          = 0x08E08488;
	constexpr int32 AppendString      = 0x029A74E0;
	constexpr int32 GNames            = 0x08DA7840;
	constexpr int32 GWorld            = 0x08CBB6C0;
	constexpr int32 ProcessEvent      = 0x02BA8CB0;
