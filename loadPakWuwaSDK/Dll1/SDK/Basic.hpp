...
namespace Offsets
{
	constexpr int32 GObjects          = 0x08720CB8;
	constexpr int32 AppendString      = 0x02AB3DD0;
	constexpr int32 GNames            = 0x086C40C0;
	constexpr int32 GWorld            = 0x08A35350;
	constexpr int32 ProcessEvent      = 0x02CBD1B0;
