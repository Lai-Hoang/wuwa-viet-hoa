...
namespace Offsets
{
	constexpr int32 GObjects          = 0x08CA2208;
	constexpr int32 AppendString      = 0x028AED90;
	constexpr int32 GNames            = 0x08C415C0;
	constexpr int32 GWorld            = 0x08B53050;
	constexpr int32 ProcessEvent      = 0x02AB0600;
