...
namespace Offsets
{
	constexpr int32 GObjects          = 0x08825428;
	constexpr int32 AppendString      = 0x0272EB00;
	constexpr int32 GNames            = 0x087C8800;
	constexpr int32 GWorld            = 0x086E88E0;
	constexpr int32 ProcessEvent      = 0x0292F210;
