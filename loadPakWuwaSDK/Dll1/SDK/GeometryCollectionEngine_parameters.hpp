...
// Function GeometryCollectionEngine.GeometryCollectionActor.ChangeObjectTypeRuntime
// 0x0001 (0x0001 - 0x0000)
struct GeometryCollectionActor_ChangeObjectTypeRuntime final
{
public:
	EObjectStateTypeEnum                          type;                                              // 0x0000(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(GeometryCollectionActor_ChangeObjectTypeRuntime) == 0x000001, "Wrong alignment on GeometryCollectionActor_ChangeObjectTypeRuntime");
static_assert(sizeof(GeometryCollectionActor_ChangeObjectTypeRuntime) == 0x000001, "Wrong size on GeometryCollectionActor_ChangeObjectTypeRuntime");
static_assert(offsetof(GeometryCollectionActor_ChangeObjectTypeRuntime, type) == 0x000000, "Member 'GeometryCollectionActor_ChangeObjectTypeRuntime::type' has a wrong offset!");
...
static_assert(offsetof(GeometryCollectionActor_RaycastSingle, ReturnValue) == 0x0000AC, "Member 'GeometryCollectionActor_RaycastSingle::ReturnValue' has a wrong offset!");
