...
static_assert(alignof(TsEntityDebugInfoManager_C_GetEntityTimeScale) == 0x000004, "Wrong alignment on TsEntityDebugInfoManager_C_GetEntityTimeScale");
static_assert(sizeof(TsEntityDebugInfoManager_C_GetEntityTimeScale) == 0x000008, "Wrong size on TsEntityDebugInfoManager_C_GetEntityTimeScale");
static_assert(offsetof(TsEntityDebugInfoManager_C_GetEntityTimeScale, entityId) == 0x000000, "Member 'TsEntityDebugInfoManager_C_GetEntityTimeScale::entityId' has a wrong offset!");
static_assert(offsetof(TsEntityDebugInfoManager_C_GetEntityTimeScale, ReturnValue) == 0x000004, "Member 'TsEntityDebugInfoManager_C_GetEntityTimeScale::ReturnValue' has a wrong offset!");
...
static_assert(alignof(TsEntityDebugInfoManager_C_SetEntityTimeScale) == 0x000004, "Wrong alignment on TsEntityDebugInfoManager_C_SetEntityTimeScale");
static_assert(sizeof(TsEntityDebugInfoManager_C_SetEntityTimeScale) == 0x000008, "Wrong size on TsEntityDebugInfoManager_C_SetEntityTimeScale");
static_assert(offsetof(TsEntityDebugInfoManager_C_SetEntityTimeScale, entityId) == 0x000000, "Member 'TsEntityDebugInfoManager_C_SetEntityTimeScale::entityId' has a wrong offset!");
static_assert(offsetof(TsEntityDebugInfoManager_C_SetEntityTimeScale, timeScale) == 0x000004, "Member 'TsEntityDebugInfoManager_C_SetEntityTimeScale::timeScale' has a wrong offset!");
