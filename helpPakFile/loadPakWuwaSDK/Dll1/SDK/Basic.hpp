...
namespace Offsets
{
	constexpr int32 GObjects          = 0x08EE3F98;
	constexpr int32 AppendString      = 0x02A39640;
	constexpr int32 GNames            = 0x08E83340;
	constexpr int32 GWorld            = 0x08D91290;
	constexpr int32 ProcessEvent      = 0x02C3B320;
