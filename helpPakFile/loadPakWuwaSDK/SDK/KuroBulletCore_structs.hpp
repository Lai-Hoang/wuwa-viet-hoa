...
public:
	...
	struct FKuroBulletDataMove                    Move;                                              // 0x00A0(0x0050)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FKuroBulletDataRender                  Render;                                            // 0x00F0(0x00E8)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FKuroBulletDataTimeScale               TimeScale;                                         // 0x01D8(0x0010)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FKuroBulletDataLogic                   Logic;                                             // 0x01E8(0x0038)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	TArray<struct FKuroBulletDataChild>           Children;                                          // 0x0220(0x0010)(Edit, BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<struct FKuroBulletGameplayAction>      GameplayActionList;                                // 0x0230(0x0010)(Edit, BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
};
