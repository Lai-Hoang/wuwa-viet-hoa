...
public:
	...
	static bool IsMale(class UObject* __WorldContext);
	static void ReleaseFromMediaPlayActor(TScriptInterface<class IBPI_SceneBp_C> sceneBpActor, class UObject* __WorldContext);
